...
class catELMoEmbedding:
    def __init__(self, weights_file='model/weights.hdf5', options_file='model/options.json'):
    ...
    def read_csv(self, file_path, use_columns="CDR3b"):
        ...
        """
        data = pd.read_csv(file_path, sep=",", header=0)[use_columns]
