...
class TCR_embedding:
    ...
    def encode(self, file_dir, encode_dim=80, model_dir=r"D:\TCR\program\encode\pMTnet\library\h5_file",
        ...
        # read cluster data
        TCR_list = self.preprocess(file_dir)
...
if __name__ == "__main__":
    encoder = TCR_embedding()
    TCR_encoded_matrix = encoder.encode("D:/TCR/TCRantigenData_unique_filt.tsv")
    print(TCR_encoded_matrix.shape)
    np.save("D:/TCR/cluster/pMTnet_tcr.npy", TCR_encoded_matrix)
