class EmbeddingNetTCR2Standalone:
    """
    This class takes the embedding operations on cdr3 and peptide sequences from NetTCR-2.0.
    This standalone version can run directly and does not require any source code from NetTCR-2.0.
...
if __name__ == '__main__':
    embedding = EmbeddingNetTCR2Standalone('testdata_NetTCR-2.0.csv')
